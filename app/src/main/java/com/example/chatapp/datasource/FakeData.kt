...
val chatList: List<Chat> = listOf(
    Chat(
        ...
        messages = listOf(
            ...
            Message("How are you? I heard that your birthday is coming soon happy birthday dear!", "2024-03-20 10:10","id1"),
            Message("i sent you a present hope you like it", "2024-03-20 10:05","id1")
        )
    ),
    Chat(
        name = "Emma",
